...
#include "VirtualCameraUtils.h"
#include <rockchip/hardware/camerabuffer/1.0/ICameraBuffer.h>
...
using  rockchip::hardware::camerabuffer::V1_0::ICameraBufferCallback;
...
struct VirtualCameraDeviceSession : public virtual RefBase,
    ...
    class OutputThread : public android::Thread,ICameraBufferCallback {
    public:
    ...
    protected:
        ...
        std::list<std::shared_ptr<native_handle>> mFramePushList;
